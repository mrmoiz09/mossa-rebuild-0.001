    ...
    return (
        <header className="header header-2">
                    ...
                    <nav className="navbar navbar-expand-lg p-0">
                        <ul className="navbar-nav justify-content-center">
                            <li className="nav-item">
                                <a className="nav-link" href="https://www.globalsuzuki.com/" target="_blank" rel="noreferrer" >suzuki global</a>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item has-child">
                                <span className="nav-link" >Owners</span>
                                <span className="menu-arrow"><img className="in-svg" src={`${urls.frontendUrl}/images/down-arrow.svg`} alt="Arrow" /></span>
                                <ul className="nav-sub-menu list-unstyled">
                                    <li className="sub-menu-item">
                                        <span >Accessories Enquiry</span>
                                    </li>
                                    <li className="sub-menu-item">
            ...
            <div className="whatsApp__fixed">
                <a href="https://wa.me/+96894760010" ><img className="in-svg" src={" https://www.svgrepo.com/show/176768/whatsapp-social-media.svg"} alt="Whatsapp" /></a>
            </div>
        </header>
    )
}
